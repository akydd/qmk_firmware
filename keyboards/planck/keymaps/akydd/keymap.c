...
qk_tap_dance_action_t tap_dance_actions[] = {
    // Tap once for down, twice for page down
    [TD_DOWN_PG_DOWN] = ACTION_TAP_DANCE_DOUBLE(KC_DOWN, KC_PGDOWN),
    // Tap once for up, twice for page up
    [TD_UP_PG_UP] = ACTION_TAP_DANCE_DOUBLE(KC_UP, KC_PGUP),
    ...
    [TD_QUOTE_SCLN] = ACTION_TAP_DANCE_DOUBLE(KC_QUOTE, KC_SCLN),
    // Tap once for comma, twice for underscore
    [TD_COMMA_UNDERSCORE] = ACTION_TAP_DANCE_DOUBLE(KC_COMM, KC_UNDS),
};
 ...
 * |-------------+-----------+-----------+------------+----------+----------+------+-----------+------+-----------+-----------+------------|
 * |   LShift/Z  |   X       |   C       |  D         |   V      |          |      |   K       |   H  |   ,/_     |   .       |   RShift// |
 * |-------------+-----------+-----------+------------+----------+----------+------+-----------+------+-----------+-----------+------------|
 * |             |           |           |    Num/Esc |  Spc     | Nav/Tab  | Enter|  Bksp     | Sym  |           |           |            |
 * `---------------------------------------------------------------------------------------------------------------------------------------'
 */
[COLEMAK_DH] = LAYOUT_planck_grid(
    KC_Q,         KC_W,         KC_F,         KC_P,            KC_B,   _______,         _______, KC_J,    KC_L,     KC_U,                    KC_Y,         TD(TD_QUOTE_SCLN),
    LCTL_T(KC_A), LALT_T(KC_R), LGUI_T(KC_S), KC_T,            KC_G,   _______,         _______, KC_M,    KC_N,     RGUI_T(KC_E),            RALT_T(KC_I), RCTL_T(KC_O),
    LSFT_T(KC_Z), KC_X,         KC_C,         KC_D,            KC_V,   _______,         _______, KC_K,    KC_H,     TD(TD_COMMA_UNDERSCORE), KC_DOT,       RSFT_T(KC_SLSH),
...
[SYM] = LAYOUT_planck_grid(
    ...
    KC_GRV,   KC_COLN,    KC_LCBR,    KC_LPRN,           KC_HASH,   _______,    _______,    _______,   KC_RPRN,   KC_RCBR,   KC_PEQL,     KC_AMPR,
    KC_DLR,   KC_CIRC,    KC_UNDS,    KC_ASTR,           _______,   _______,    _______,    _______,   KC_MINS,   KC_BSLS,   KC_TILDE,    _______,
    _______,  _______,    _______,    TO(COLEMAK_DH),    _______,   _______,    _______,    _______,   TO(NAV),   _______,   _______,     _______
),
/* Numbers
 * ,-----------------------------------------------------------------------------------.
...
[NAV] = LAYOUT_planck_grid(
    _______,  _______,    KC_MS_U,    _______,           _______,    _______,    _______,    _______,    KC_MPLY,       TD(TD_VOLD_MUTE),    KC_VOLU,         _______,
    _______,  KC_MS_L,    KC_MS_D,    KC_MS_R,           _______,    _______,    _______,    _______,    KC_LEFT,       TD(TD_DOWN_PG_DOWN), TD(TD_UP_PG_UP), KC_RIGHT,
    _______,  _______,    _______,    _______,           _______,    _______,    _______,    _______,    _______,       KC_END,              KC_HOME,         _______,
    _______,  _______,    _______,    TO(COLEMAK_DH),    _______,    _______,    _______,    KC_MS_BTN1, KC_MS_BTN2,    _______,             _______,         _______
),
