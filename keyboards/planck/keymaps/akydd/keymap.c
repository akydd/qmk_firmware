 ...
 * |      Z      |   X       |   C       |  D         |   V          |          |      |   K       |   H  |    ,      |   .       |     /      |
 * |-------------+-----------+-----------+------------+--------------+----------+------+-----------+------+-----------+-----------+------------|
 * |             |           |           |    Num/Esc |  Nav/LShift  | Nav      |      |    Spc    | Sym  |           |           |            |
 * `-------------------------------------------------------------------------------------------------------------------------------------------'
 */
[ARSTNEIO] = LAYOUT_planck_grid(
    _______,      _______,      _______,      _______,         _______,                _______,         _______, _______,   _______,     _______,         _______,         _______,
    LCTL_T(KC_A), LALT_T(KC_R), LGUI_T(KC_S), KC_T,            _______,                _______,         _______, _______,   KC_N,        RGUI_T(KC_E),    RALT_T(KC_I),    RCTL_T(KC_O),
    _______,      _______,      _______,      _______,         _______,                _______,         _______, _______,   _______,     _______,         _______,         _______,
    _______,      _______,      _______,      LT(NUM, KC_ESC), OSM(MOD_LSFT),          MO(NAV),         _______, KC_SPC,    OSL(SYM),    _______,         _______,         _______
),
...
[SYM] = LAYOUT_planck_grid(
    ...
    KC_GRV,   KC_COLN,    KC_LCBR,    KC_LPRN,           _______,   _______,    _______,    _______,   KC_RPRN,   KC_RCBR,   KC_PEQL,     KC_AMPR,
    KC_DLR,   KC_CIRC,    KC_UNDS,    KC_ASTR,           _______,   _______,    _______,    _______,   KC_MINS,   KC_BSLS,   KC_TILDE,    KC_HASH,
    _______,  _______,    _______,    TO(ARSTNEIO),      _______,   TO(NUM),    _______,    _______,   TO(NAV),   _______,   _______,     _______
),
/* Numbers
 * ,-----------------------------------------------------------------------------------.
...
[NUM] = LAYOUT_planck_grid(
    ...
    _______,  _______,  _______,  TO(ARSTNEIO),   _______,    _______,    _______,    _______,    OSL(SYM),  _______,  _______,  _______
),

[NAV] = LAYOUT_planck_grid(
    _______,  _______,    _______,    _______,           _______,       _______,    _______,    _______,    _______,       _______,   _______,       _______,
    KC_MPLY,  KC_VOLD,    KC_VOLU,    KC_MUTE,           _______,       _______,    _______,    _______,    KC_LEFT,       KC_DOWN,   KC_UP,         KC_RIGHT,
    _______,  _______,    _______,    _______,           _______,       _______,    _______,    _______,    _______,       _______,   _______,       _______,
    _______,  _______,    _______,    TO(ARSTNEIO),      _______,       _______,    _______,    _______,    _______,       _______,   _______,       _______
),
