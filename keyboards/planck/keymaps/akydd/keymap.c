...
[SYM] = LAYOUT_planck_grid(
    ...
    KC_GRV,  KC_COLN,     KC_LCBR,    KC_LPRN,    KC_HASH,    _______,    _______,    KC_BSLS,   KC_RPRN,    KC_RCBR,   KC_PEQL,     KC_AMPR,
    KC_DLR,  KC_CIRC,    KC_UNDS,    KC_ASTR,    _______,     _______,    _______,    _______,   KC_MINS,    _______,   _______,     _______,
    _______,  _______,    _______,    _______,    _______,    _______,    _______,    _______,   _______,    _______,   _______,     _______
),
