 ...
 * |-------------+-----------+-----------+------------+----------+----------+------+-----------+------+-----------+-----------+------------|
 * |             |           |           |    Num/Esc |  Spc     | Nav/Tab  | Enter|  Sym      | Bksp |           |           |            |
 * `---------------------------------------------------------------------------------------------------------------------------------------'
 */
[COLEMAK_DH] = LAYOUT_planck_grid(
    ...
    LSFT_T(KC_Z),    KC_X,            KC_C,            KC_D,                 KC_V,              _______,           _______,  KC_K,              KC_H,    KC_COMM,         KC_DOT,          RSFT_T(KC_SLSH),
    _______,         _______,         _______,         LT(NUM, KC_ESC),      KC_SPC,            LT(NAV, KC_TAB),   KC_ENT,   KC_BSPC,           MO(SYM), _______,        _______,         _______
),

/* Numbers
 * ,-----------------------------------------------------------------------------------.
 * |  F1  |  F2  |  F2  |  F2  |  F5  |      |      |  F6  |  F7  |  F8  |  F8  | F10  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |  1   |   2  |   3  |   4  |      |      |      |      |   7  |   8  |   9  |  0   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | F11  | F12  |      |   5  |      |      |      |      |   6  |      |      |      |
...
[NUM] = LAYOUT_planck_grid(
    ...
    KC_F11,   KC_F12,     _______,    KC_5,       _______,    _______,    _______,    _______,   KC_6,     _______,  _______,  _______,
    _______,  _______,    _______,    _______,    _______,    _______,    _______,    _______,   _______,  _______,  _______,  _______
),

[NAV] = LAYOUT_planck_grid(
    _______,  _______,    _______,    _______,    _______,    _______,    _______,    _______,   KC_VOLD,  KC_VOLU,   KC_MUTE,  KC_MPLY,
...
[SYM] = LAYOUT_planck_grid(
    ...
    KC_DLR,   KC_CIRC,    KC_UNDS,    KC_ASTR,    _______,   _______,    _______,    _______,   KC_MINS,    KC_BSLS,   _______,     _______,
    _______,  _______,    _______,    _______,    _______,   _______,    _______,    _______,   _______,    _______,   _______,     _______
),
